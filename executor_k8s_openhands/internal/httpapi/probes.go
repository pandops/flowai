...
// RegisterProbesWithExecutorID resolves executor_id per request so first-start
// registration can expose the Registry-generated UUID after it is persisted.
func RegisterProbesWithExecutorID(r chi.Router, serviceName string, executorID func() string, ready ReadinessChecker) {
	...
	r.Get("/readyz", func(w http.ResponseWriter, req *http.Request) {
		...
		body.KubeReachable = deps.KubeReachable

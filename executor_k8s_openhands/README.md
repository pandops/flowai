...
```bash
GOROOT=/usr/local/go /usr/local/go/bin/go run ./executor_k8s_openhands/cmd/executor_k8s_openhands \
  -config executor_k8s_openhands/configs/executor_k8s_openhands.yaml
GOROOT=/usr/local/go /usr/local/go/bin/go test ./executor_k8s_openhands/...
```

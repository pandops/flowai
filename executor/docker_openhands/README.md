...
```bash
env -u GOROOT go run ./executor/docker_openhands/cmd/executor_docker_openhands \
  -config executor/docker_openhands/configs/executor_docker_openhands.yaml
env -u GOROOT go test ./executor/docker_openhands/...
```

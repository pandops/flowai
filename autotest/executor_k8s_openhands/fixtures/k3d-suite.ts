      ...
      try {
        ...
        await run(
          ...
          [
            ...
            EXECUTOR_IMAGE,
            "--file",
            "executor_k8s_openhands/Dockerfile",
            ".",
          ],
          { timeoutMs: 600_000 },
        );
        ...
        await run(
          ...
          [
            ...
            AGENT_IMAGE,
            "--file",
            "autotest/executor_k8s_openhands/mock-openhands/Dockerfile",
            ".",
          ],
          { timeoutMs: 600_000 },
        );
        ...
        await run(
          ...
          [
            "--file",
            "executor_k8s_openhands/deploy/k8s/helmfile.yaml",
            "apply",
            "--set",
        ...
        const installSystemExecutor = async (): Promise<{
          ...
          await run(
            ...
            [
              ...
              "executor_k8s_openhands/deploy/k8s/chart",
              "--namespace",
              systemNamespace,
              "--create-namespace",
              "--values",
              "executor_k8s_openhands/deploy/k8s/values-k3d.yaml",
              "--set",
              `stateRegistryURL=${registryURL}`,
              "--set",

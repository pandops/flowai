...
- **File**: [`autotest/executor_docker_opehands/tests/executor.spec.ts:33`](../../executor_docker_opehands/tests/executor.spec.ts)
...
`executor_docker_opehands` binary on port 18020 (default ports from
`autotest/executor_docker_opehands/tests/helpers.ts`).

...
Define the provider-neutral authentication, secure browser-session, canonical team-resolution, and immutable one-team working-token contract owned by API Gateway.

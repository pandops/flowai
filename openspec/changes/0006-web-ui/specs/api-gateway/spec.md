...
The API Gateway SHALL accept Web UI REST requests and WebSocket upgrades without login or bearer-token validation in this change, and auth SHALL be added only by `0007-auth`.

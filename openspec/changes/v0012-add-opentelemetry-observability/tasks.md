...
- [ ] 3.3 Implement the independent `executor_docker_openhands/internal/telemetry` package with the same external behavior but no import from State Registry or any shared FlowAI package.
